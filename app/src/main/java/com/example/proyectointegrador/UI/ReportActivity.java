    ...
    private void cargarViajes() {
        new Thread(() -> {
            try {
                ...
                URL urlTickets = new URL(ApiConfig.getApiUrl(ReportActivity.this, "/ticket/my-tickets/" + studentId));
                ...
                for (int i = 0; i < ticketsArray.length(); i++) {
                    ...
                    if ("used".equalsIgnoreCase(status)) {
                        ...
                        if (!tripIds.contains(tripId) && tripId != null && !tripId.isEmpty() && !tripId.equals("null")) {
                            tripIds.add(tripId);
                        }
                    }
                }
                        ...
                        if (id.equals(tripId)) {
                            ...
                            if ("completed".equalsIgnoreCase(status)) {
                                ...
                                for (int j = 0; j < routesArray.length(); j++) {
                                    ...
                                    String routeIdFromArray = routeJson.has("Id") ? routeJson.getString("Id") : routeJson.getString("id");
                                    if (routeIdFromArray.equals(trip.routeId)) {
                                        trip.routeName = routeJson.has("RouteName") ? routeJson.getString("RouteName") : routeJson.getString("routeName");
                                        break;
                                    }
                                }
